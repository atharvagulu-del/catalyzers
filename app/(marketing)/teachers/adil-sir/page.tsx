                            ...
                            <div className="relative p-8 md:p-12 flex flex-col md:flex-row gap-8 lg:gap-16 items-center">
                                ...
                                <div className="flex-1 text-center md:text-left z-10">
                                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 mb-6">
                                        ...
                                        <span className="text-sm font-bold text-indigo-700 tracking-wide uppercase">14 Years Experience</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center md:justify-start gap-2 text-slate-600 mb-8 bg-slate-50 px-4 py-3 rounded-2xl w-fit mx-auto md:mx-0 border border-slate-100">
                                        ...
                                        <span className="font-medium">Specializes in JEE & NEET Physics</span>
                                    </div>
                        ...
                        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 md:p-12 lg:p-16 relative overflow-hidden">
                            ...
                            <div className="prose prose-lg max-w-none text-slate-600">
                                <p className="leading-relaxed mb-6 text-lg">
                                    <strong className="text-slate-800">Adil Sir</strong> is the Founder and Senior Physics Faculty with over 14 years of experience teaching Physics for JEE and NEET.
                                ...
                                <p className="leading-relaxed mb-6 text-lg">
                                    His teaching emphasizes conceptual understanding, logical reasoning, and strong problem-solving skills. Adil Sir ensures that students don&apos;t just memorize formulas but truly understand Physics and learn how to apply concepts effectively in high-pressure exam scenarios.
                                </p>
