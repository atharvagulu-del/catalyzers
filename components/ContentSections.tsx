                        ...
                        {[
                            {
                                ...
                                hrefNeet: "/courses/neet-11th",
                                hrefJee: "/courses/jee-11th",
                                icon: (
                                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                hrefNeet: "/courses/neet-12th",
                                hrefJee: "/courses/jee-12th",
                                icon: (
                                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                hrefNeet: "/courses/neet-dropper",
                                hrefJee: "/courses/jee-dropper",
                                icon: (
                                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            >
                                ...
                                <div className={`relative bg-white border border-slate-200 rounded-[2rem] p-8 pb-10 h-full flex flex-col z-10 shadow-sm transition-all duration-500 ease-out xl:group-hover:-translate-y-2 xl:group-hover:-translate-x-2 xl:hover:scale-[1.02] ${program.shadow}`}>
                                    ...
                                    <div className="mt-auto flex gap-4 pt-6 border-t border-slate-100">
                                        <a href={program.hrefNeet} className="flex-1 flex justify-center items-center gap-2 py-3 rounded-xl bg-slate-50 border border-slate-100 hover:bg-rose-50 hover:border-rose-200 text-slate-700 hover:text-rose-600 font-bold transition-all group/btn">
                                            NEET
                                        ...
                                        <a href={program.hrefJee} className="flex-1 flex justify-center items-center gap-2 py-3 rounded-xl bg-slate-50 border border-slate-100 hover:bg-blue-50 hover:border-blue-200 text-slate-700 hover:text-blue-600 font-bold transition-all group/btn">
                                            JEE
                                            <svg className="w-4 h-4 transform group-hover/btn:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                        </a>
                                    </div>
